...
//        如果从文件中加载的数据长度为0，自动先加入三条数据
        ...
        Log.e("hh",String.valueOf(accountArrayList.size())+"onCreate");
...
//            TODO:下面是搜索数字，但是还没对非数字进行处理，所以输入非数字搜索会报错
    ...
    public void onDestroyView() {
        Log.e("hh",String.valueOf(accountArrayList.size())+"onDestroy1");
        accountArrayList= billadapter.getList();
//        accountArrayList=dataServer.Load(BillFragment.this.getContext());//测试
        Log.e("hh",String.valueOf(accountArrayList.size())+"onDestroy2");
